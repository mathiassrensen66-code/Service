      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#A8B5A0] transition-colors"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold mb-4 text-[#A8B5A0]">Services</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold mb-4 text-[#A8B5A0]">Kontakt</h4>
            <ul className="space-y-3 text-white/60">
              <li>+45 12 34 56 78</li>
              <li>info@danishtextilecare.dk</li>
              <li>Hele Sjælland</li>
              <li className="pt-2">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">
            © {new Date().getFullYear()} Danish Textile Care. Alle rettigheder forbeholdes.
          </p>
